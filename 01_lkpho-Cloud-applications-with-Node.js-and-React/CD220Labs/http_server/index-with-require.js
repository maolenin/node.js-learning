...
const requestListener = function (req, res) {
    ...
    let dateVal = today.getDate(); // Get the currrent dat from the 'today' module

    // Determine the appropiate greeting  based on the current time
    let greeting = "It is still not morning";
    if (dateVal.getHours() > 6 && dateVal.getHours() < 12) {
      greeting = "Good morning!";
    } else if (dateVal.getHours() >= 12 && dateVal.getHours() < 21) {
